...
const LensProfile = ({ profile, mintedLevels, setMintedLevels }) => {
        ...
        <div className="w-full sm:w-3/5 p-2 border-white border-2 bg-slate-800 rounded-lg">
            <div className="w-full rounded-lg ">
                ...
                <div className="border border-white flex justify-end">
                    ...
                    <MintingModal setMintedLevels={setMintedLevels} mintedLevels={mintedLevels} setShowModal={setShowModal} profile={profile} level={calculateLevel(calculateExperience(profile.stats.totalFollowing, profile.stats.totalFollowers, profile.stats.totalPosts, profile.stats.totalCollects, profile.stats.totalMirrors, profile.stats.totalComments)).level} />
                )}
                {/* Header */}
