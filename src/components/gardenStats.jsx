...
const NextExpProgress = ({ unlocksAtLevel, xpNeededToUnlock, myTotalXp }) => {
    ...
    return (
        <div className="flex items-center sm:pt-3 justify-between">
...
const GardenStats = ({ profile }) => {
    ...
    const renderNFTGarden = () => {
        if (updatedDB) {
            return (
                ...
                <div className='sm:flex mt-2 sm:mt-4 gap-y-4 grid grid-cols-1 w-full sm:justify-between sm:items-center rounded-lg bg-transparent'>
                    {/* Points calculation */}
                   
                    {/* NFT Image */}
                    <main className="p-1 rounded-lg border-2 border-white bg-slate-800 sm:ml-2">

                        <div className="w-full p-4 mx-auto items-center justify-center sm:w-[335px] rounded-lg">
                            <div className='text-center text-white pb-1 underline mx-auto text-xl'><p>{data.name}</p></div>
                            <div className="border-white border cursor-pointer flex mt-2 mb-2 sm:mb-6 justify-center items-center mx-auto nft rounded-lg">
                                <img src={data.image} className="rounded-lg w-full sm:w-full" alt="" aria-hidden="true" />
                            </div>
                    ...
                    <main className="p-1 rounded-lg border-2 border-white bg-slate-800">

                            <div className="w-full p-2 mx-auto items-center justify-center sm:w-[335px] rounded-lg">
                                <div className='text-center text-white pb-1 underline mx-auto text-xl'><p>{nextNFT.name}</p></div>
                                <div className="border-white border cursor-pointer flex mt-2 mb-2 sm:mb-6 justify-center items-center mx-auto nft rounded-lg">
                                    <img src={nextNFT.imageUrl} className="rounded-lg w-full" alt="" aria-hidden="true" />
                                </div>
                                <div className="sm:text-lg text-sm text-white w-1/2 mx-auto items-center justify-center flex">
                                    <p>Locked
                                    </p>
                                ...
                                <div className="font flex justify-center mx-auto items-center">
                                    <p className='sm:text-lg text-sm text-white'>
                                        Experience to unlock 
                                         <p className='sm:text-lg text-sm flex justify-center'>{XP} / {nextNFT.xpNeededtoUnlock}</p>
                                    </p>
                                    </div>
                                ...
                                <div className="border-2 sm:mb-3 border-green-500"></div>
                            </div>
                        </main>


                        <main className="p-2 rounded-lg border-2 border-white bg-slate-800 sm:mr-2">
                        <div className="w-full p-4 mx-auto items-center justify-center sm:w-[335px] rounded-lg">
                        <div className='text-center text-white pb-1 underline mx-auto text-xl'><p>Tier: #1 NFT</p></div>
                        <div className="border-white border cursor-pointer flex mt-2 mb-2 sm:mb-6 justify-center items-center mx-auto nft rounded-lg">
                        <img src={data.image} className="rounded-lg w-full sm:w-full" alt="" aria-hidden="true" />
                        </div>
                        <div className="sm:text-lg text-sm text-white w-1/2 mx-auto items-center justify-center flex">
    ...
    return (
        ...
        <div className="nft rounded-lg w-full bg-[#14243d] text-center pb-4 ">
                    <div className=' font pt-5 sm:text-2xl text-lg px-2 sm:px-0 relative text-white'>Points Calculation.
                    <div className="sm:w-1/6 w-2/3 flex mx-auto border-2 sm:mt-2 mt-2 border-green-500"></div>
                    </div>
                    
                        <div className="grid grid-cols-2 sm:justify-items-center sm:grid-cols-3 w-full sm:mt-3 gap-2 p-2">
