        ...
        if (updatedDB) {
            return (
                ...
                <div className='nft w-full md:flex md:justify-between md:items-center p-4 rounded-lg bg-slate-800'>
                    ...
                    {/* NFT Image */}
                    <main className="card-wrapper p-2 rounded-lg">

                        <div className="card nft rounded-lg">
                    ...
                    <div className=" md:w-4/5 p-2">
                        <main className="card-wrapper p-2 rounded">

                            <div className="card w-full nft rounded-lg">
