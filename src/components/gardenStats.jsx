...
const calculateLevel = (experience) => {
    ...
    <div className='text-center text-white pb-1 underline mx-auto text-xl'><p>{data.name}</p></div>
      ...
      <div class="level flex">
         ...
         <svg className='h-6 w-6' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256"><rect  fill="none"/><circle cx="128" cy="144" r="20" fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="12"/><line x1="128" y1="164" x2="128" y2="180" fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="12"/><rect x="40" y="88" width="176" height="128" rx="8" fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="12"/><path d="M92,88V52a36,36,0,0,1,71.8-4" fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="12"/></svg>
         </div>
      ...
      <div class="card-seperator mt-6 border-2 border-green-500"></div>
                    ...
                    <main class="card-wrapper p-2 rounded">
                        ...
                        <div class="card w-full nft rounded-lg">
                        <div className='text-center text-white pb-1 underline mx-auto text-xl'><p>{nextNFT.name}</p></div>
                          ...
                          <div class="level flex">
                             ...
                             <svg className='h-6 w-6 ml-2' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256"><rect fill="none"/><circle cx="128" cy="140" r="20" fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="12"/><line x1="128" y1="160" x2="128" y2="184" fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="12"/><rect x="40" y="88" width="176" height="128" rx="8" fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="12"/><path d="M92,88V52a36,36,0,0,1,72,0V88" fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="12"/></svg>
                             </div>
                          <div class="card-details">
                            <p>
                    ...
                    <NextExpProgress unlocksAtLevel={nextNFT.unlocksAtLevel} xpNeededToUnlock={nextNFT.xpNeededtoUnlock} myTotalXp={XP} />
                          ...
                          <div class="card-seperator border-2 mt-6 border-green-500"></div>
