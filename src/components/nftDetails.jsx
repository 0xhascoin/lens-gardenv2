...
const NftDetails = () => {
    return (
        ...
        <div class="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3 py-3">
           ...
           <ImageCard imageSrc={'https://cdn.midjourney.com/39731e06-e97b-4802-91da-139ae32bea1d/grid_0.png'} imageTitle={"Lens Garden NFT #5: Baby tree"} imageText={"Unlocks at level 18"} imageDesc={"65,537,000 XP points needed to unlock this"}/>
           ...
           <ImageCard imageSrc={'https://cdn.midjourney.com/d980f8b4-c4e8-4e7e-84d9-7d5006a320d5/grid_0.png'} imageTitle={"Lens Garden NFT #6: Oak"} imageText={"Unlocks at level 27"} imageDesc={"33,554,433,000 XP points needed to unlock this"} />
           <ImageCard imageSrc={'https://cdn.midjourney.com/b5ae6e99-e7c5-4705-ae4d-9c89303aa386/grid_0.png'} imageTitle={"Lens Garden NFT #7: Grandpa Oak"} imageText={"Unlocks at level 35"} imageDesc={"8,589,934,593,000 XP points needed to unlock this"} />
         </div>
       </div>
    )
}
